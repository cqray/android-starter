 ...
 * @author Cqray
 */
public class ApplicationLifecycleDispatcher implements Application.ActivityLifecycleCallbacks {

    /** 调度器单例 **/
    private static volatile ApplicationLifecycleDispatcher sInstance;
    ...
    public static void initialize(Application application) {
        if (sInstance == null) {
            synchronized (ApplicationLifecycleDispatcher.class) {
                if (sInstance == null) {
                    sInstance = new ApplicationLifecycleDispatcher(application);
                }
            }
        }
    }

    private ApplicationLifecycleDispatcher(Application application) {
    ...
    public void onActivityCreated(@NonNull Activity activity, @Nullable Bundle savedInstanceState) {
        if (activity instanceof AppCompatActivity) {
            if (activity instanceof SupportDelegateProvider) {
                SupportDelegate delegate = ((SupportDelegateProvider) activity).getSupportDelegate();
                delegate.onCreated(savedInstanceState);
            }
            FragmentManagerDelegate.get((AppCompatActivity) activity).onCreated();
    ...
    public void onActivityDestroyed(@NonNull Activity activity) {
        if (activity instanceof AppCompatActivity) {
            ...
            FragmentManagerDelegate.get((AppCompatActivity) activity).onDestroyed();
        }
    }
    ...
    static final class SupportFragmentCallbacks extends FragmentManager.FragmentLifecycleCallbacks {
        ...
        public SupportFragmentCallbacks(AppCompatActivity activity) {
        ...
        public void onFragmentCreated(@NonNull FragmentManager fm, @NonNull Fragment f, @Nullable Bundle savedInstanceState) {
            ...
            FragmentManagerDelegate.get(f).onCreated();
        }
        ...
        public void onFragmentDestroyed(@NonNull FragmentManager fm, @NonNull Fragment f) {
            ...
            FragmentManagerDelegate.get(f).onDestroyed();
        }
    }
}
